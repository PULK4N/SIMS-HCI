...
namespace HospitalApp.Service
{
    ...
    {
        public  (List<Appointment>, bool) GetAppointments(SchedulingInformation schedulingInformation)
        {
            bool priorityApplied = false;
            List<Appointment> alreadyScheduled = Map.AppointmentController.GetAllByDoctorId(schedulingInformation.Doctor.DoctorId);
        ...
        private  void applyPriority(List<Appointment> appointmentsToSchedule, List<Appointment> alreadyScheduled, SchedulingInformation schedulingInformation)
        {
            ...
            {
                List<Doctor> doctors = Map.DoctorController.GetAllBySpecialization(Enums.Specialization.NONE);
        ...
        private  bool noAppointmentsAvailable(List<Appointment> appointments)
        {
            return appointments.Count() == 0;
        }
        private  void GenerateNewAppointments(List<Appointment> appointments, SchedulingInformation schedulingInformation)
        {
        ...
        private  bool inDoctorWorkingHours(SchedulingInformation schedulingInformation, DateTime AppointmentTime)
        {
            return
        ...
        private  void RemoveOverlappingAppointments(List<Appointment> appointmentsToSchedule, List<Appointment> appointmentsToRemove)
        {
        ...
        private  bool isOverlapping(Appointment appointment, Appointment scheduledAppointment)
        {
        ...
        private  bool appointmentOverlapping(Appointment appointment, List<Appointment> alreadyScheduledAppointments)
        {
        ...
        private  void filterUnavilableAppointments(List<Appointment> appointmentsToSchedule, List<Appointment> alreadyScheduled)
        {
        ...
        private  List<Appointment> GeneratePriorityScheduledAppointments(List<Appointment> appointmentsToSchedule, List<Doctor> doctors, SchedulingInformation schedulingInformation)
        {
            foreach (Doctor doctor in doctors)
            {
                List<Appointment> alreadyScheduled = Map.AppointmentController.GetAllByDoctorId(doctor.DoctorId);
        ...
        private  void GenerateAppointmentsAtDifferentTime(List<Appointment> appointmentsToSchedule, List<Appointment> alreadyScheduled, SchedulingInformation schedulingInformation)
        {
        ...
        private  bool isMoreThan2DaysAppart(SchedulingInformation schedulingInformation)
        {//Ako je istog dana
        ...
        private  bool startsInLessThan24Hours(SchedulingInformation schedulingInformation)
        {
        ...
        private  bool canReschedule(SchedulingInformation schedulingInformation)
        {
        ...
        public  bool ReSchedulingInformationValid(SchedulingInformation schedulingInformation)
        {
